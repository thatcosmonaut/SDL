...
SDL_DYNAPI_PROC(SDL_GPUQuery*,SDL_BeginGPUQuery,(SDL_GPUCommandBuffer *a,SDL_GPUQueryType b,SDL_PropertiesID c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_EndGPUQuery,(SDL_GPUCommandBuffer *a,SDL_GPUQuery *b),(a,b),)
SDL_DYNAPI_PROC(bool,SDL_ReadGPUQuery,(SDL_GPUDevice *a,SDL_GPUQuery *b,Uint64 *c),(a,b,c),return)
SDL_DYNAPI_PROC(void,SDL_ReleaseGPUQuery,(SDL_GPUDevice *a,SDL_GPUQuery *b),(a,b),)
